...
#847386e00494999d0367257403ffd08960514785
import os
os.environ["CUDA_DEVICE_ORDER"]="PCI_BUS_ID"
os.environ["CUDA_VISIBLE_DEVICES"]="3" #Select your GPUs
...
parser.add_argument("--EMB_DIR", type=str, default="data/", help="Embedding directory")
...
# data
parser.add_argument("--src_langs", type=str, nargs='+', default=['de','es','nl','ko','it','ru'], help="Source languages")
...
parser.add_argument("--dico_eval", type=str, default="train", help="Path to evaluation dictionary")
...
#MT learning
parser.add_argument('--use_mt_learning', type=bool_flag, default=False, help="Do you want to use MT learning?" )
parser.add_argument("--n_gaze_feat", type=int, default="4", help="Number of Gaze features")
parser.add_argument("--alpha", type=float, default=0.5, help="alpha for lbtw method")
parser.add_argument("--mt_method", type=str, default="None")
parser.add_argument("--loss_multi", type=float, default=1)
parser.add_argument("--loss_add", type=float, default=2)
parser.add_argument("--validset", type=str, default="train")
...
wandb.init(project="umwe", entity="{specify}", name=params.exp_name)
...
embs, mappings, discriminators, gaze_features = build_model(params, True)
#trainer = Trainer(embs, mappings, discriminators, params)
trainer = Trainer(embs, mappings, discriminators, gaze_features, params)
    ...
    for n_epoch in range(params.n_epochs):
        ...
        for n_iter in range(0, params.epoch_size, params.batch_size):
            ...
            for _ in range(params.dis_steps):
                trainer.dis_step(stats, params.mt_method)
                trainer.nDisStep += 1

            # mapping training (discriminator fooling)
            n_words_proc += trainer.mapping_step(stats, params.mt_method)
