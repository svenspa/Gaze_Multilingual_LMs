...
parser.add_argument('--ner_dir', default='./data/wikiann_ner/')
parser.add_argument('--gaze_dir', default='./data/gaze/')
parser.add_argument('--n_gaze_feat', type=int, default=4)
parser.add_argument('--use_mt_learning/', dest='use_mt_learning', action='store_true', default=False)
parser.add_argument('--alpha', type=float, default=0.5)
parser.add_argument('--loss_multi', type=float, default=1)
parser.add_argument('--loss_add', type=float, default=2)
...
parser.add_argument('--fix_charemb', dest='fix_charemb', action='store_true', default=True)
parser.add_argument('--no_fix_charemb', dest='fix_charemb', action='store_false')
...
parser.add_argument('--fix_emb', dest='fix_emb', action='store_true', default=True)
parser.add_argument('--no_fix_emb', dest='fix_emb', action='store_false')
...
parser.add_argument('--use_data_parallel/', dest='use_data_parallel', action='store_true', default=True)
...
parser.add_argument('--evalset', dest='evalset', default='wikiann')
...
UMWE_EMB = {
    ...
    'deu': './data/embeddings/umwe-fullexport/umwe.200k.deesnlkoitru2en.de.vec',
    'esp': './data/embeddings/umwe-fullexport/umwe.200k.deesnlkoitru2en.es.vec',
    'kor': './data/embeddings/umwe-fullexport/umwe.200k.deesnlkoitru2en.ko.vec',
    'rus': './data/embeddings/umwe-fullexport/umwe.200k.deesnlkoitru2en.ru.vec',
    'ita': './data/embeddings/umwe-fullexport/umwe.200k.deesnlkoitru2en.it.vec',
    'ned': './data/embeddings/umwe-fullexport/umwe.200k.deesnlkoitru2en.nl.vec'
}
UMWE_GAE = {
    'en': './data/embeddings_gae/wiki.200k.en.vec',
    'de': './data/embeddings_gae/umwe-fullexport/umwe.200k.de-en.de.vec',
    'es': './data/embeddings_gae/umwe-fullexport/umwe.200k.es-en.es.vec',
    'zh': './data/embeddings_gae/umwe-fullexport/umwe.200k.zh-en.zh.vec',
    'fr': './data/embeddings_gae/umwe-fullexport/umwe.200k.fr-en.fr.vec',
    'ja': './data/embeddings_gae/umwe-fullexport/umwe.200k.ja-en.ja.vec',
    'eng': './data/embeddings_gae/wiki.200k.en.vec',
    'deu': './data/embeddings_gae/umwe-fullexport/umwe.200k.deesnlkoitru2en.de.vec',
    'esp': './data/embeddings_gae/umwe-fullexport/umwe.200k.deesnlkoitru2en.es.vec',
    'kor': './data/embeddings_gae/umwe-fullexport/umwe.200k.deesnlkoitru2en.ko.vec',
    'rus': './data/embeddings_gae/umwe-fullexport/umwe.200k.deesnlkoitru2en.ru.vec',
    'ita': './data/embeddings_gae/umwe-fullexport/umwe.200k.deesnlkoitru2en.it.vec',
    'ned': './data/embeddings_gae/umwe-fullexport/umwe.200k.deesnlkoitru2en.nl.vec'
}
DEFAULT_VECMAP_EMB = {
...
for i, lang in enumerate(opt.all_langs):
    ...
    elif opt.default_emb == 'gae':
        def_fn = UMWE_GAE[lang]
    else:
        def_fn = ''
